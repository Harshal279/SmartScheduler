...
def display_welcome_screen():
    ...
    with col2:
        st.markdown("""
        ### 🎓 Final Year Project 
                B.Tech AI Students (Group-15)
        G. H. Raisoni College of Engineering, Nagpur
                    
        - **Name:** Sourabh Dhadade  (A-56)
        - **Name:** Mohit Raut  (A-34)
        - **Name:** Harshal Ghoradkar  (A-27)
        - **Name:** Anshu Pandey  (A-20)
        - **Guide:** Assistant Prof. Yogesh Pathak""")
